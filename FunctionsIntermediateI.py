...
print()
def printInfo(list):
    print(str(len(list['locations'])) + " LOCATIONS")
    for j in range (0, len(list['locations'])):
        print(list['locations'][j])
    print()
    print(str(len(list['instructors'])) + " INSTRUCTORS")
    for k in range (0, len(list['instructors'])):
        print(list['instructors'][k])
